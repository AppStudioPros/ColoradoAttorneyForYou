...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0b1726] text-gray-400 py-12 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 min-[900px]:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <p>
                <a href="tel:+17204957315" className="hover:text-accent transition-colors">
                  Phone: (720) 495-7315
                </a>
              </p>
          ...
          <div>
            ...
            <nav className="space-y-2 text-sm">
              ...
              <Link
                href="/unemployment-appeals"
                className="block hover:text-accent transition-colors"
              >
                Unemployment Appeals
              </Link>
              <Link href="/other-areas" className="block hover:text-accent transition-colors">
                Other Areas
              </Link>
            </nav>
          </div>
